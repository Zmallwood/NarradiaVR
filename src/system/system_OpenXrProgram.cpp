...
#include "model/func_GetXrReferenceSpaceCreateInfo.h"
#include "model/func_GetXrReferenceSpaceCreateInfoTiles.h"
#include "system_ProgramLogger.h"
#include "controller/InputActionsController.h"
...
namespace nar {
   ...
   void OpenXrProgram::InitSession() {
      ...
      GET(InputActionsController)->InitInputActions();
